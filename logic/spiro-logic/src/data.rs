...
#[pyclass(eq, eq_int)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum LineStyle { Solid, Dashed, Dotted, DashDot }

#[pyclass(eq, eq_int)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum MarkerStyle { Circle, Square, Triangle, Cross, Plus }

#[pyclass]
#[derive(Debug, Clone, Copy, PartialEq)]
pub struct Vec2 {
    #[pyo3(get, set)] pub x: f32,
    #[pyo3(get, set)] pub y: f32,
}

#[pymethods]
impl Vec2 {
    #[new] fn new(x: f32, y: f32) -> Self { Vec2 { x, y } }
    fn __repr__(&self) -> String { format!("Vec2(x={}, y={})", self.x, self.y) }
}
...
pub struct Color {
    ...
    #[pyo3(get, set)] pub a: f32,
}

#[pymethods]
impl Color {
    #[new] fn new(r: f32, g: f32, b: f32, a: f32) -> Self { Color { r, g, b, a } }
    #[staticmethod]
    ...
    fn __repr__(&self) -> String { format!("Color(r={}, g={}, b={}, a={})", self.r, self.g, self.b, self.a) }
}
...
pub struct TextConfig {
    ...
    #[pyo3(get, set)] pub color: Color,
    #[pyo3(get, set)] pub size: f32,
}

#[pymethods]
impl TextConfig {
    #[new] fn new(text: String, color: Color, size: f32) -> Self { TextConfig { text, color, size } }
}

#[pyclass]
#[derive(Debug, Clone)]
pub struct GridConfig {
    #[pyo3(get, set)] pub visible: bool,
    #[pyo3(get, set)] pub color: Color,
    #[pyo3(get, set)] pub style: LineStyle,
}

#[pymethods]
impl GridConfig {
    #[new] fn new(visible: bool, color: Color, style: LineStyle) -> Self { GridConfig { visible, color, style } }
}

#[pyclass]
#[derive(Debug, Clone)]
pub struct AxisConfig {
    #[pyo3(get, set)] pub label: Option<TextConfig>,
    #[pyo3(get, set)] pub limits: Option<(f32, f32)>,
    #[pyo3(get, set)] pub visible: bool,
}
...
pub struct LineArtist {
    #[pyo3(get, set)] pub points: Vec<Vec2>,
    #[pyo3(get, set)] pub color: Color,
    #[pyo3(get, set)] pub linewidth: f32,
    #[pyo3(get, set)] pub style: LineStyle,
}
...
pub struct TextArtist {
    #[pyo3(get, set)] pub config: TextConfig,
    #[pyo3(get, set)] pub position: Vec2,
    #[pyo3(get, set)] pub h_align: HorizontalAlign,
    #[pyo3(get, set)] pub v_align: VerticalAlign,
}
...
#[derive(Debug)]
pub struct PlotAxes {
    #[pyo3(get, set)] pub artists: Vec<PyObject>,
    #[pyo3(get, set)] pub title: Option<TextConfig>,
    #[pyo3(get, set)] pub x_axis: AxisConfig,
    #[pyo3(get, set)] pub y_axis: AxisConfig,
    #[pyo3(get, set)] pub grid: GridConfig,
}
...
pub struct Figure {
    ...
    #[pyo3(get, set)] pub size_pixels: (u32, u32),
}
